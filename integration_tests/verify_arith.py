...
Usage:
    cat test_vectors/arith_1/*.txt | python3 verify_arith.py --binary ./arith_1 --arity 1
    ./generators/arith.py --arity 1 | python3 verify_arith.py --binary ./arith_1 --arity 1 --fuzz
